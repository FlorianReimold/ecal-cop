...
namespace cereal
{
  ...
  template <class Archive>
  void serialize(Archive& archive, eCAL::Registration::SProcess& sprocess)
  {
    archive(sprocess.rclock, sprocess.hname, sprocess.hgname, sprocess.pid, sprocess.pname,
      sprocess.uname, sprocess.pparam,
  ...
  {
    archive(sample.cmd_type, sample.host, sample.process, sample.topic);
  }
} // namespace cereal
