...
typedef struct _eCAL_pb_Logging {
    pb_callback_t logs; /* log messages */
} eCAL_pb_Logging;
...
#define eCAL_pb_Logging_init_default             {{{NULL}, NULL}}
...
#define eCAL_pb_Logging_init_zero                {{{NULL}, NULL}}
...
#define eCAL_pb_Logging_logs_tag                 1
...
#define eCAL_pb_Logging_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  logs,              1)
#define eCAL_pb_Logging_CALLBACK pb_default_field_callback
#define eCAL_pb_Logging_DEFAULT NULL
#define eCAL_pb_Logging_logs_MSGTYPE eCAL_pb_LogMessage

extern const pb_msgdesc_t eCAL_pb_LogMessage_msg;
extern const pb_msgdesc_t eCAL_pb_Monitoring_msg;
extern const pb_msgdesc_t eCAL_pb_Logging_msg;
