...
#define eCAL_pb_ConnnectionPar_init_default      {false, eCAL_pb_LayerParUdpMC_init_default}
...
#define eCAL_pb_ConnnectionPar_init_zero         {false, eCAL_pb_LayerParUdpMC_init_zero}
...
#define ECAL_PB_LAYER_PB_H_MAX_SIZE              eCAL_pb_TLayer_size
#define eCAL_pb_ConnnectionPar_size              2
#define eCAL_pb_LayerParUdpMC_size               0
#define eCAL_pb_TLayer_size                      20
